...
**Stand Milestone 1 und 2**: beide auf main gesichert, kein Pipeline-Neulauf, das veroeffentlichte Frontend unveraendert. Beide Fixes greifen erst im naechsten Full-Run, der jetzt entkoppelt ist: Location-Fix und Mojibake-Repair liegen vor, der Re-Run kann sie gemeinsam mit der 2979-zeigen-mit-Titel-Entscheidung regenerieren (Milestone 3, oeffentlich, operator-gated).
