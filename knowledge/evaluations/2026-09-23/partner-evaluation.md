---
title: Partner Acceptance Worksheet
status: draft
language: en
created: 2026-09-23
related: [owner-evaluation, production-readiness, status]
---
...
1. Search for two or three publications you know, using search and the language filter. Is each found, and does the result make clear which publication matched?
2. Open a page that lists several editions or contributions. Is it clear which edition each year, publisher, place, translator and extent belongs to?
3. Open the source evidence of one entry. Can you see what the source says and what has been reviewed, proposed or left open?
4. Export a citation (BibTeX or RIS) for one publication and import it into your reference manager. Would you cite it as exported?
5. Look at one entry marked as contested or open for review. Is the uncertainty stated in a way you can work with?
6. Publication scope: do you agree to the scope, responsibility and licences stated above?

## Responses

| Task | Partner | Response | Date |
|---|---|---|---|
| 1 | | | |
| 2 | | | |
| 3 | | | |
