...
| Data | `klawiter.json` (~8 MB) | Generated by [[pipeline]] |
...
docs/
  ...
  data/
    klawiter.json     5,179 total entries (4,751 ns0 displayed) + 1,078 redirects
```

### Views

**Overview** (`#`): Category portal — intro text, search field, 15 entry type tiles grouped by Works / Reception & Impact / Editions. Summary stats line.
