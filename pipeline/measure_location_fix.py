...
from lib.config import STEP_03_OUTPUT, OUTPUT_DIR
...
def main():
    ...
    print(f"unchanged {t['unchanged']}  changed {t['changed']}  "
          f"gained {t['gained']}  lost {t['lost']}")
    print(f"weimar old={w['old_value_weimar']}  corrected={w['corrected']}  "
